...
public class AjouterPatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("N∞ SÈcuritÈ Sociale :");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTextField1.getText().equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "Veuillez rentrer un pr√©nom", "Erreur", JOptionPane.ERROR_MESSAGE);
        } else if (jTextField3.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Veuillez rentrer un num√©ro de s√©curit√© sociale", "Erreur", JOptionPane.ERROR_MESSAGE);
            ...
            JOptionPane.showMessageDialog(null, "Veuillez rentrer un num√©ro de t√©l√©phone", "Erreur", JOptionPane.ERROR_MESSAGE);
        } else{
            DossierMed dossierMed = new DossierMed();
        dossierMed.setVisible(true); 
        this.setVisible(false);
